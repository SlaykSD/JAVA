...
public class FirstTask {
    ...
    public static void main(String[] args) {
       ...
       // int d2 = linDeath.minusYears(linDeath.getYear() - linBirthday.getYear()).isAfter(linBirthday)?1:0;
        System.out.println("He was " + ((linDeath.getYear() - linBirthday.getYear()) +
               d ) + " years old");

        System.out.println("He  lived "+ getDaysLived(linBirthday,linDeath)+ " days");
        System.out.println("He  lived "+ Duration.between(linBirthday.atStartOfDay(),linDeath.atStartOfDay()).toDays()+ " days");
        ...
        System.out.println("Answer: " + arrivalTime.minusHours(departureTime.getHour()).minusMinutes(departureTime.getMinute()));
